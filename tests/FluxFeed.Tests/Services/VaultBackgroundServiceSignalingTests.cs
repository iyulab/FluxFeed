...
public class VaultBackgroundServiceSignalingTests
{
    ...
    private sealed class FakeQueueService : IVaultQueueService, IDisposable
    {
        ...
        public Task<IReadOnlyList<VaultJob>> GetJobsAsync(VaultJobStatus? s = null, VaultJobType? t = null, int? limit = null, int? offset = null, bool newestFirst = false, CancellationToken ct = default) => Task.FromResult<IReadOnlyList<VaultJob>>(Array.Empty<VaultJob>());
